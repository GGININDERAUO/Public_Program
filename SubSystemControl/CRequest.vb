...
#Region "�ܼƫŧi"
    ...
    'Protected m_PanelId As String
    'Protected m_Pattern As String
...
#End Region
    ...
    Public Function RequestXml() As System.Xml.XmlDocument
        ...
        ' Action
        XmlElement = XmlDoc.CreateElement("Command")
        XmlElement.InnerText = Me.m_Command
        XmlDoc.DocumentElement.AppendChild(XmlElement)
        ' PanelId
        'XmlElement = XmlDoc.CreateElement("PanelId")
        'XmlElement.InnerText = Me.m_PanelId
        'XmlDoc.DocumentElement.AppendChild(XmlElement)
        ' Pattern
        'XmlElement = XmlDoc.CreateElement("Pattern")
        'XmlElement.InnerText = Me.m_Pattern
        'XmlDoc.DocumentElement.AppendChild(XmlElement)
        ' Param1
